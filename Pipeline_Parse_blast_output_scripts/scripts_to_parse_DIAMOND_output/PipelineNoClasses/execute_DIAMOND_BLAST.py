...
diamond_blast_output_file_directory = "/home/roosmarijnbaars/Desktop/Onderzoek_BioCentre/BLAST_with_DIAMOND/output_DIAMOND_BLAST_sensitive_MGcV_complete_dataset_max_hits_25_roosmarijnbaars/"
...
def diamond_blast():
    ...
    for input_fasta_file in file_list:
        ...
        commands = [
            "diamond blastx -d " + diamond_blast_database_location + blast_database_name + " -q " + input_fasta_file + " -a " + diamond_blast_output_filemame_daa + " -t " + diamond_temp_dir + " -k " + max_hits_per_read + " -e" + max_evalue + " " + sensitive,
            "diamond view -a " + diamond_blast_output_filemame_daa + " -o " + diamond_blast_output_filemame_tsv]
